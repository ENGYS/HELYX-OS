...
import eu.engys.dynamic.cellzones.MultiBodyDynamicMeshPanel;
...
public class StandardMultiBodyDynamicMeshPanel extends MultiBodyDynamicMeshPanel {
    ...
    public StandardMultiBodyDynamicMeshPanel(Model model, DynamicModule module) {
        super(model, module);
    }

    @Override
    protected SolidBodyDynamicPanel createSolidBodyPanel() {
        return new StandardSolidBodyDynamicPanel(model, module);
    }
