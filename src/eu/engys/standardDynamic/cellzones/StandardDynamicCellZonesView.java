...
public class StandardDynamicCellZonesView extends DynamicCellZonesView {

    public StandardDynamicCellZonesView(Model model, DynamicModule module) {
        super(model, module);
    }
    ...
    public List<CellZoneType> getCellZoneTypes() {
        ...
        types.add(new StandardDynamicMesh(model, module));
        return types;
    }
