...
public class StandardVOFTreeView implements TreeView {

    private StandardVOFModule module;
    private ModulePanel phasesPanel;

    public StandardVOFTreeView(StandardVOFModule module, PhasesPanel phasesPanel) {
        this.module = module;
        this.phasesPanel = phasesPanel;
    }

    @Override
    public void updateTree(ModuleElementPanel viewElementPanel) {
        if (module.isVOF()) {
