...
public class ApplicationInfo {
	...
	public static void init() {
	    try {
		    ...
		    LoggerFactory.getLogger(ApplicationInfo.class).warn(e.getMessage());
            name = DEFAULT_NAME;
            vendor = DEFAULT_VENDOR;
            versionNumber = DEFAULT_NUMBER;
            majorNumber = DEFAULT_NUMBER;
    ...
    public static String getHeaderInfo() {
        ...
        sb.append("\n     OS:            " + getSystemPropertyOrEmpty(SystemEnv.OS_NAME) + " " + getSystemPropertyOrEmpty(SystemEnv.OS_VERSION) + " " + getSystemPropertyOrEmpty(SystemEnv.OS_ARCH));
        ...
        sb.append("\n JAVA");
        sb.append("\n -----------------------------------------------------");
        sb.append("\n     Version         " + getSystemPropertyOrEmpty(SystemEnv.JAVA_VERSION));
        sb.append("\n     Vendor          " + getSystemPropertyOrEmpty(SystemEnv.JAVA_VENDOR));
        sb.append("\n     Home            " + getSystemPropertyOrEmpty(SystemEnv.JAVA_HOME));
        sb.append("\n     ClassVersion    " + getSystemPropertyOrEmpty(SystemEnv.JAVA_CLASS_VERSION));
        sb.append("\n     ClassPath       " + getClassPath());
        sb.append("\n");
        sb.append("\n USER");
        sb.append("\n -----------------------------------------------------");
        sb.append("\n     Name            " + getSystemPropertyOrEmpty(SystemEnv.USER_NAME));
        sb.append("\n     Home            " + getSystemPropertyOrEmpty(SystemEnv.USER_HOME));
        sb.append("\n     Dir             " + getSystemPropertyOrEmpty(SystemEnv.USER_DIR));
        sb.append("\n");
        sb.append("\n RMI");
        sb.append("\n -----------------------------------------------------");
        sb.append("\n     Client Logging  " + getSystemPropertyOrEmpty(SystemEnv.RMI_CLIENT_LOG));
        sb.append("\n     Client Level    " + getSystemPropertyOrEmpty(SystemEnv.RMI_CLIENT_LOG_LEVEL));
        sb.append("\n     Server Logging  " + getSystemPropertyOrEmpty(SystemEnv.RMI_SERVER_LOG));
        sb.append("\n     Server Level    " + getSystemPropertyOrEmpty(SystemEnv.RMI_SERVER_LOG_LEVEL));
        sb.append("\n     Transport Level " + getSystemPropertyOrEmpty(SystemEnv.RMI_TRANSPORT_LOG_LEVEL));
        sb.append("\n     Server Hostname " + getSystemPropertyOrEmpty(SystemEnv.RMI_SERVER_HOSTNAME));
        sb.append("\n");
        return sb.toString();
    }
    
    private static String getSystemPropertyOrEmpty(String propertyName){
