...
import eu.engys.util.filechooser.actions.pathnavigation.BaseNavigateAction;
...
/**
 */
public class OpenFavorite extends BaseNavigateAction {

    private JList<Favorite> favoriteList;

    public OpenFavorite(FileChooserController controller, JList<Favorite> favoriteList) {
        super(controller, "Open", FOLDEROPEN);
