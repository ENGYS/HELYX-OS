...
public final class VFSUtils {
	...
	static {
		schemeIconMap.put("file", ResourcesUtil.getIcon("drive.icon"));
		schemeIconMap.put("jar", ResourcesUtil.getIcon("jar.icon"));
		schemeIconMap.put("smb", ResourcesUtil.getIcon("samba.icon"));
		schemeIconMap.put("sftp", ResourcesUtil.getIcon("network.icon"));
		schemeIconMap.put("ftp", ResourcesUtil.getIcon("network.icon"));
		schemeIconMap.put("http", ResourcesUtil.getIcon("network.icon"));
		schemeIconMap.put("https", ResourcesUtil.getIcon("network.icon"));
		schemeIconMap.put("zip", ResourcesUtil.getIcon("archive.icon"));
		schemeIconMap.put("tar", ResourcesUtil.getIcon("archive.icon"));
		schemeIconMap.put("tgz", ResourcesUtil.getIcon("archive.icon"));
		schemeIconMap.put("tbz", ResourcesUtil.getIcon("archive.icon"));
