...
public class FileChooserUtils {
    ...
    public static final HelyxFileFilter STL_FILTER = new HelyxFileFilter("STL File (*.stl)", STL_EXTENSION);
    public static final HelyxFileFilter CSV_FILTER = new HelyxFileFilter("CSV File (*.csv)", CSV_EXTENSION);
    public static final HelyxFileFilter XLS_FILTER = new HelyxFileFilter("Excel File (*.xls, *.xlsx)", EXCEL_EXTENSION_OLD, EXCEL_EXTENSION_NEW);
    ...
    public static File getExcelFile() {
        ...
        File file = null;
        ReturnValue retVal = fc.showSaveAsDialog(XLS_FILTER);
    ...
    public static File getCSVFile() {
        ...
        fc.setSelectionMode(SelectionMode.FILES_ONLY);
        File file = null;
        ReturnValue retVal = fc.showSaveAsDialog(CSV_FILTER);
