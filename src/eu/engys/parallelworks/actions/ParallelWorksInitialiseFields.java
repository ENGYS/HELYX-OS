...
import static eu.engys.core.controller.AbstractScriptFactory.INITIALISE_FIELDS_PARALLEL;
import static eu.engys.core.controller.AbstractScriptFactory.INITIALISE_FIELDS_SERIAL;
...
public class ParallelWorksInitialiseFields extends InitialiseFields {

    private static final Logger logger = LoggerFactory.getLogger(ParallelWorksInitialiseFields.class);
    private ProgressMonitor monitor;

    public ParallelWorksInitialiseFields(Model model, Controller controller, ScriptFactory scriptFactory, ProgressMonitor monitor) {
    ...
    public void beforeExecute() {
        super.beforeExecute();
        String command = model.getProject().isSerial() ? INITIALISE_FIELDS_SERIAL : INITIALISE_FIELDS_PARALLEL;
