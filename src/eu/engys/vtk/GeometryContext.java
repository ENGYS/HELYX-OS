...
public class GeometryContext extends Context {
    ...
    // private Map<String, vtkProperty> actorsProperty;

    public GeometryContext(Representation representation, Map<Surface, Actor> actorsMap) {
        super(representation);
        this.actorsMap = new ActorsMap(actorsMap);
        this.actorsVisibility = initActorsVisibility(actorsMap);
        // this.actorsProperty = initActorsProperty(actorsMap);
    }
