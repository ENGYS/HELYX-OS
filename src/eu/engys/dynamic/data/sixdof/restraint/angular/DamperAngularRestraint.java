...
public class DamperAngularRestraint extends AngularRestraint {

    public static final String COEFF = "coeff";
    private double coeff = 0.0;

    public DamperAngularRestraint() {
    }

    public DamperAngularRestraint(double coeff) {
        this.coeff = coeff;
    }
    
    @Override
    public AngularRestraint copy() {
        return new DamperAngularRestraint(coeff);
    }

    @Override
    public AngularRestraintType getType() {
        return AngularRestraintType.DAMPER;
    }
