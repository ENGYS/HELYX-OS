...
public class AxisRotationMotionFunction extends SolidBodyMotionFunction {
    ...
    public AxisRotationMotionFunction() {
    }

    @Override
    public SolidBodyMotionFunction copy() {
        AxisRotationMotionFunction function = new AxisRotationMotionFunction();
    ...
    public SolidBodyMotionFunctionType getFunctionType() {
        return SolidBodyMotionFunctionType.AXIS_ROTATION_MOTION;
    }
