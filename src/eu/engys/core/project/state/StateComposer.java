...
public class StateComposer {
    ...
    public StateComposer dynamic() {
        state.setDynamic(true);
        return this;
    }
    
    public StateComposer adjoint() {
        state.setAdjoint(true);
        return this;
    }
    ...
    public StateComposer spalartAllmaras_LES_OS() {
        state.setTurbulenceModel(new TurbulenceModel("SpalartAllmarasDES", TurbulenceModelType.Spalart_Allmaras));
        return this;
    }
