...
public class ServerState implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        ServerState fz = (ServerState) obj;
        return new EqualsBuilder().append(command, fz.command).append(solverState, fz.solverState).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 31).append(command).append(solverState).toHashCode();
    }
}
