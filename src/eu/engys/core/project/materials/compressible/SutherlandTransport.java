...
public class SutherlandTransport extends AbstractBean implements Transport {
    ...
    public void setAs(double as) {
        firePropertyChange(AS_KEY, this.as, this.as = as);
    }
    public double getTs() {
        return ts;
    }
    public void setTs(double ts) {
        firePropertyChange(TS_KEY, this.ts, this.ts = ts);
    }
