...
public class HerschelBulkleyTransportModel extends AbstractBean implements TransportModel {

    public static final String NU0_KEY = "nu0";
    public static final String TAU0_KEY = "tau0";
    ...
    public void setTau0(double tau0) {
        firePropertyChange(TAU0_KEY, this.tau0, this.tau0 = tau0);
    }
    public double getK() {
        return k;
    }
