...
public interface MaterialsReader {
	...
	void readSingle_Material(Materials materials, TransportProperties tpp, ProgressMonitor monitor);

	void readSingle_Material(Materials materials, ThermophysicalProperties tfp, ProgressMonitor monitor);
