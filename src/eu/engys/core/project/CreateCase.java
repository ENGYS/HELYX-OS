...
public class CreateCase {
    ...
    public openFOAMProject create(CaseParameters params) {
        ...
        try {
            ...
            systemFolder.setStretchMeshDict(defaults.getDefaultStretchMeshDict());
    ...
    public static void deleteAll(File baseDir, boolean isParallel, int nProcessors) {
        ...
        if (isParallel) {
            ...
            for (File timeDir : baseDir.listFiles(new TimeDirectoryFileFilter())) {
                FileUtils.deleteQuietly(timeDir);
            }
        }
    ...
    private static class TimeDirectoryFileFilter implements FileFilter {
