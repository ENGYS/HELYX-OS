...
public class CaseParameters {
    ...
    public String toString() {
        return String.format("New %s case (%s processors [%s, %s, %s] ) - ", isParallel() ? "parallel" : "serial", getnProcessors(), getnHierarchy()[0], getnHierarchy()[1], getnHierarchy()[2], getBaseDir().getAbsolutePath());
    }
