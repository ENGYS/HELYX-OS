...
public class BoundaryType {
    ...
    public static final BoundaryType INLET = new BoundaryType(INLET_KEY, INLET_LABEL, true, true);
    public static final BoundaryType OUTLET = new BoundaryType(OUTLET_KEY, OUTLET_LABEL, true, true);
    public static final BoundaryType OPENING = new BoundaryType(OPENING_KEY, OPENING_LABEL, true, true);
    public static final BoundaryType WALL = new BoundaryType(WALL_KEY, WALL_LABEL, true, true);
    public static final BoundaryType PATCH = new BoundaryType(PATCH_KEY, PATCH_LABEL, true, true);
    public static final BoundaryType SYMMETRY = new BoundaryType(SYMMETRY_KEY, SYMMETRY_LABEL, false, true);
    public static final BoundaryType SYMMETRY_PLANE = new BoundaryType(SYMMETRY_PLANE_KEY, SYMMETRY_PLANE_LABEL, false, true);
    public static final BoundaryType CYCLIC = new BoundaryType(CYCLIC_KEY, CYCLIC_LABEL, true, true);
    public static final BoundaryType CYCLIC_AMI = new BoundaryType(CYCLIC_AMI_KEY, CYCLIC_AMI_LABEL, true, true);
    public static final BoundaryType EMPTY = new BoundaryType(EMPTY_KEY, EMPTY_LABEL, false, true);
    public static final BoundaryType WEDGE = new BoundaryType(WEDGE_KEY, WEDGE_LABEL, false, true);
    public static final BoundaryType FREE_SURFACE = new BoundaryType(FREE_SURFACE_KEY, FREE_SURFACE_LABEL, true, true);

    public static final BoundaryType PROCESSOR = new BoundaryType(PROCESSOR_KEY, PROCESSOR_LABEL, false, false);
    public static final BoundaryType PROCESSOR_CYCLIC = new BoundaryType(PROCESSOR_CYCLIC_KEY, PROCESSOR_CYCLIC_LABEL, false, false);
    ...
    public static boolean isFreeSurfacePhysicalType(String key) {
        return key.equals(FREE_SURFACE_KEY);
    }

    public static boolean isSymmetryPlanePhysicalType(String key) {
        return key.equals(SYMMETRY_PLANE_KEY);
    }

    public static boolean isSymmetryPhysicalType(String key) {
        return key.equals(SYMMETRY_KEY);
    }
    ...
    public static boolean isCyclic(String key) {
        return key.equals(CYCLIC_KEY);
    }

    public static boolean isInlet(Patch patch) {
        return patch.getPhysicalType().getKey().equals(INLET_KEY);
    }
    ...
    private BoundaryType(String key, String label, boolean hasBoundaryConditions, boolean editable) {
        this.key = key;
        this.label = label;
    ...
    public boolean equals(Object obj) {
        ...
        BoundaryType type = (BoundaryType) obj;
        return new EqualsBuilder().append(key, type.key).isEquals();
    }
