...
//         ExecUtil.execParallelAndWait(runnables);
    ...
    private void _write(Fields fields, final File zeroDir) {
        if (fields.isEmpty()) {
            ...
            ZeroFolderUtil.clearFiles(fields.orderedFieldsNames(), zeroDir);
...
//         ExecUtil.execParallelAndWait(runnablesForBuffer);
    }
...
//         ExecUtil.execParallelAndWait(runnablesForWrite);
    }
}
