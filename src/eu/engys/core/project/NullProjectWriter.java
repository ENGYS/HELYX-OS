...
public class NullProjectWriter extends AbstractProjectWriter {

    @Inject
    public NullProjectWriter(Model model, Set<ApplicationModule> modules, ProgressMonitor monitor) {
