...
public class StopCommandAction extends ViewAction {

    public static final String STOP_EXECUTION = "Stop Execution";

    private Runnable stopCommand;

    public StopCommandAction() {
        this(false);
    }

    public StopCommandAction(boolean label) {
        super(label ? STOP_EXECUTION : null, ResourcesUtil.getIcon("console.stop.icon"), STOP_EXECUTION);
    }
