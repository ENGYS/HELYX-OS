...
public class ExportToPNGAction extends AbstractAction {
	...
	private static final Icon PNG_ICON = ResourcesUtil.getIcon("file.png");
	private SelectedViewProvider selector;

	public ExportToPNGAction(SelectedViewProvider selector) {
		super("", PNG_ICON);
		this.selector = selector;
		putValue(SHORT_DESCRIPTION, "Export chart in PNG format");
	}

	@Override
	public void actionPerformed(ActionEvent e) {
		selector.getSelectedView().exportToPNG();
	}
