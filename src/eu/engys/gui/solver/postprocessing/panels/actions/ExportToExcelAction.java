...
public class ExportToExcelAction extends AbstractAction {
    ...
    public ExportToExcelAction(SelectedViewProvider selector) {
        super("", EXCEL_ICON);
        this.selector = selector;
        putValue(SHORT_DESCRIPTION, "Export chart data in Excel format");
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        selector.getSelectedView().exportToExcel();
    }
}
