...
public class ShowCrosshairForResidualsAction extends AbstractAction {

	private static final Icon CROSSHAIR_ICON = ResourcesUtil.getIcon("crosshair.icon");
	private ResidualsView residualsView;

	public ShowCrosshairForResidualsAction(ResidualsView residualsView) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		residualsView.setCrosshairVisibile(visible);
	}
}
