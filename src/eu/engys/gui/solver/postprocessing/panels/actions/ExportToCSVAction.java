...
public class ExportToCSVAction extends AbstractAction {
    ...
    private static final Icon CSV_ICON = ResourcesUtil.getIcon("file.icon");
    private SelectedViewProvider selector;

    public ExportToCSVAction(SelectedViewProvider selector) {
        super("", CSV_ICON);
        this.selector = selector;
        putValue(SHORT_DESCRIPTION, "Export chart data in CSV format");
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        selector.getSelectedView().exportToCSV();
    }
