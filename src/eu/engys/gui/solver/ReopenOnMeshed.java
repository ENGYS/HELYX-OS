...
public class ReopenOnMeshed implements ServerListener {

	private Controller controller;

	public ReopenOnMeshed(Controller controller) {
		this.controller = controller;
	}
	
	@Override
	public void serverChanged(ServerState serverState) {
	    if (serverState.getCommand().equals(Command.CREATE_MESH)) {
	        if (serverState.getSolverState().isMeshed()) {
