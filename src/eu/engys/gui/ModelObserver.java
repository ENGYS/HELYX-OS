...
public interface ModelObserver {
    ...
    void fieldManipulationFunctionObjectsChanged();

    void monitoringFunctionObjectsChanged();
    
    void monitoringFunctionObjectChanged(MonitoringFunctionObject fo);

    void stateChanged();

    void fieldsChanged();

    void boundaryTypeChanged(BoundaryType arg);

    void geometryChanged();

    void runtimeFieldsChanged();
