...
public class TransformSurfaceEvent extends EventObject implements View3DEvent{

	private Surface[] surfaces;
	private AffineTransform transformation;
    private boolean save;

	public TransformSurfaceEvent(AffineTransform t, boolean save, Surface... surfaces) {
		super(t);
        this.save = save;
