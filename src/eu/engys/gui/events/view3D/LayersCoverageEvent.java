...
public class LayersCoverageEvent extends EventObject implements View3DEvent {

	private EventActionType action;
    private JPanel colorBar;
    private LayerInfo layerInfo;

	public LayersCoverageEvent(LayerInfo layerInfo, JPanel colorBar, EventActionType action) {
		super();
