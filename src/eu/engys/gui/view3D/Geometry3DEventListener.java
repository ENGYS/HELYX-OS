...
import eu.engys.gui.events.view3D.FilterSurfaceEvent;
...
public class Geometry3DEventListener implements View3DEventListener {
    ...
    public void eventTriggered(final Object obj, final Event event) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                } else if (event instanceof FilterSurfaceEvent) {
                    handleFilterSurface((FilterSurfaceEvent) event);
    ...
    private void handleFilterSurface(FilterSurfaceEvent event) {
        Surface selection[] = event.getSelection();
        controller.updateSurfacesFilter(selection);        
    }
