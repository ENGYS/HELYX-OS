...
public class AutomaticBaseMeshPanel {
    ...
    public static final String BASE_MESHSPACING_LABEL = "Base Mesh Spacing";
    ...
    public AutomaticBaseMeshPanel(Model model, DictionaryPanelBuilder builder) {
        this.model = model;
    ...
    public void save() {
        ...
        model.getGeometry().saveAutoBlock(model);
    }
