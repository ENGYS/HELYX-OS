...
public class ScalarNonUniformInterpolationTable extends DictionaryTableAndChartPanel {

    private static final Logger logger = LoggerFactory.getLogger(ScalarNonUniformInterpolationTable.class);
    ...
    public ScalarNonUniformInterpolationTable(String[] columnNames) {
