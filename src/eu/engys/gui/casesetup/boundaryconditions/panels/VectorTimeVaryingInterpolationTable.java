...
public class VectorTimeVaryingInterpolationTable extends DictionaryTableAndChartPanel {

    private static final Logger logger = LoggerFactory.getLogger(VectorTimeVaryingInterpolationTable.class);
    ...
    public VectorTimeVaryingInterpolationTable(String[] columnNames) {
    ...
    protected TableModel createTableModel() {
        DefaultTableModel tableModel = new DefaultTableModel(data, new String[] { TIME_STEP_LABEL, columnNames[0], columnNames[1], columnNames[2] }) {
            @Override
    ...
    protected Double[][] toObject(String tableData) {
        ...
        if (tableData.startsWith("(") && tableData.endsWith(")")) {
            ...
            logger.error("Parsing error: '{}' does not start/end with '(' or ')' ", tableData);
        }
