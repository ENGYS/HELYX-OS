...
public class GeneralScalarTable extends DictionaryTableAndChartPanel {

    private static final Logger logger = LoggerFactory.getLogger(GeneralScalarTable.class);
    ...
    public GeneralScalarTable(String key, String label, String columnName) {
        super(label, label, DISTANCE_M_LABEL, "", true, new String[] { columnName });
        this.key = key;
    ...
    protected TableModel createTableModel() {
        DefaultTableModel tableModel = new DefaultTableModel(data, new String[] { DISTANCE_M_LABEL, columnName }) {
            @Override
    ...
    public void save(Dictionary dictionary) {
        ...
        if (dictionary.found(finder)) {
            ...
            dictionary.add(key + " table", value);
        }
    }
